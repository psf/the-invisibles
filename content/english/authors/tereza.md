...
social:
  - label: github
    ...
    url: https://github.com/terezaif

  - label: twitter
    icon: fa-brands fa-x-twitter
    url: https://twitter.com/terezaif

  - label: linkedin
    icon: fa-brands fa-linkedin
    url: https://linkedin.com/in/tereza-iofciu
  
  - label: mastodon
    icon: fa-brands fa-mastodon
    url: https://vis.social/@terezaif

  - label: web
    icon: fa-solid fa-globe
    url: https://terezaiofciu.com
---
